...
1. Read the [dataset TODO]() with `pandas`.
2. Do some exploratory analysis to understand the data.
3. Choose a methodology to model the price of AirBnBs. Consider:
...
4. Transform the data into relevant variables. Consider:
    * Handling missing data.
    * Re-coding categorical variables.
    * Standardizing / normalizing variables.
    * Extracting information from text variables.
5. Fit your regression model.
6. Evaluate the model performance.
7. Visualize / communicate the results. 

To help you get started, I have made a basic [project scaffold TODO](). 
...
We will then compare everyone's solutions, and we will discuss your results, the different challenges that you faced throughout the process, and how you overcame them.
